...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card-2">
	<a class="w3-bar-item w3-btn w3-padding-large w3-hide-medium w3-hide-large w3-right" style="margin-top:10px" href="javascript:void(0)" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a>
	<div class="w3-container w3-margin-right w3-padding w3-left">
		...
		<button onclick="searchBar()" class="w3-padding-large w3-bar-item w3-hover-text-grey w3-hide-small w3-right" style="font-size:20px;margin-top:10px"><i id="searchbutton" class="fa fa-search"></i></button>
    <div id="searchbar" class="w3-dropdown-content w3-bar-block w3-border w3-display-topright" style="margin-top:60px">
      <a href="#" class="w3-button w3-black w3-right"><i class="fas fa-search"></i></a>
      <input type="text" class="w3-col s9 w3-bar-item w3-input w3-right" placeholder="Search..">
    </div>
		<a id="contact" href="{{url('/contact')}}"
      class="w3-identica link hvr-grow w3-text-grey w3-hover-text-black w3-bar-item w3-padding-large w3-hide-small w3-right w3-dinmed w3-margin">
      Contact</a>
		<a id="services" href="{{url('/services')}}"
      class="w3-identica link hvr-grow w3-text-grey w3-hover-text-black w3-bar-item w3-padding-large w3-hide-small w3-right w3-dinmed w3-margin">
      Services</a>
		<a id="projects" href="{{url('/projects')}}"
      class="w3-identica link hvr-grow w3-text-grey w3-hover-text-black w3-bar-item w3-padding-large w3-hide-small w3-right w3-dinmed w3-margin">
      Projects</a>
    <div class="w3-dropdown-click w3-right w3-hover-white" >
      <a id="profile" onclick="dropdownProfile();"
        class="w3-identica link hvr-grow w3-text-grey w3-hover-text-black w3-bar-item w3-padding-large w3-hide-small w3-dinmed w3-margin">
        Profile <i class="fas fa-caret-down"></i></a>
        <div id="Demo" class="w3-dropdown-content w3-bar-block w3-border" style="margin-top:80px">
          <a href="{{(url('/profile1'))}}" class="w3-bar-item w3-button w3-identica">Our Profile</a>
          <a href="{{(url('/profile2'))}}" class="w3-bar-item w3-button w3-identica">Traditional Dance</a>
          <a href="{{(url('/profile3'))}}" class="w3-bar-item w3-button w3-identica">Modern Dance</a>
          <a href="{{(url('/profile1'))}}" class="w3-bar-item w3-button w3-identica">Music</a>
        </div>
    </div>
...
<footer class="w3-container w3-padding-32 w3-center w3-opacity w3-light-grey w3-xlarge">
  <a target="_blank" href="https://www.instagram.com/ktfui/"><i class="fab fa-instagram w3-hover-opacity" style="font-size:40px"></i></a>
  <a target="_blank" href="https://www.youtube.com/user/KTFfisipUI08"><i class="fab fa-youtube w3-hover-opacity" style="font-size:40px"></i></a>
  <a target="_blank" href="https://twitter.com/ktfui"><i class="fab fa-twitter w3-hover-opacity" style="font-size:40px"></i></a>
  <a target="_blank" href="https://www.facebook.com/ktf.ui.radhasarisha"><i class="fab fa-facebook-square w3-hover-opacity" style="font-size:40px"></i></a>
